...
router.post("/scrape", authMiddleware_1.default, leadController_1.scrapeLeads);
router.get("/linkedin/:leadId", authMiddleware_1.default, leadController_1.getLinkedInLeadData);
